...
if (!class_exists(Kernel::class) || (Kernel::MAJOR_VERSION >= 7 || Kernel::MAJOR_VERSION === 6 && Kernel::MINOR_VERSION === 4)) {
    class PlaceholdersIdGetResponse200Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return \is_object($data) && 'JoliCode\\Forecast\\Api\\Model\\PlaceholdersIdGetResponse200' === $data::class;
        }
        ...
        {
            return ['JoliCode\\Forecast\\Api\\Model\\PlaceholdersIdGetResponse200' => false];
        }
    }
} else {
    class PlaceholdersIdGetResponse200Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
