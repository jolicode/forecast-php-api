...
class PlaceholderBodyNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    use CheckArray;
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \JoliCode\Forecast\Api\Model\PlaceholderBody();
        if (null === $data || false === \is_array($data)) {
            return $object;
        }
        if (\array_key_exists('placeholder', $data) && null !== $data['placeholder']) {
            $object->setPlaceholder($this->denormalizer->denormalize($data['placeholder'], 'JoliCode\\Forecast\\Api\\Model\\PlaceholderBodyPlaceholder', 'json', $context));
