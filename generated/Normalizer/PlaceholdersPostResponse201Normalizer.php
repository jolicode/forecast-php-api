...
if (!class_exists(Kernel::class) || (Kernel::MAJOR_VERSION >= 7 || Kernel::MAJOR_VERSION === 6 && Kernel::MINOR_VERSION === 4)) {
    class PlaceholdersPostResponse201Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        use CheckArray;
        ...
        {
            return 'JoliCode\\Forecast\\Api\\Model\\PlaceholdersPostResponse201' === $type;
        }

        public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
        {
            return \is_object($data) && 'JoliCode\\Forecast\\Api\\Model\\PlaceholdersPostResponse201' === $data::class;
        }
        ...
        public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
        {
            ...
            $object = new \JoliCode\Forecast\Api\Model\PlaceholdersPostResponse201();
        ...
        {
            return ['JoliCode\\Forecast\\Api\\Model\\PlaceholdersPostResponse201' => false];
        }
    }
} else {
    class PlaceholdersPostResponse201Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
