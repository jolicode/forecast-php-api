...
if (!class_exists(Kernel::class) || (Kernel::MAJOR_VERSION >= 7 || Kernel::MAJOR_VERSION === 6 && Kernel::MINOR_VERSION === 4)) {
    class RepeatedAssignmentSetBodyRepeatedAssignmentSetNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return \is_object($data) && 'JoliCode\\Forecast\\Api\\Model\\RepeatedAssignmentSetBodyRepeatedAssignmentSet' === $data::class;
        }
        ...
        {
            return ['JoliCode\\Forecast\\Api\\Model\\RepeatedAssignmentSetBodyRepeatedAssignmentSet' => false];
        }
    }
} else {
    class RepeatedAssignmentSetBodyRepeatedAssignmentSetNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
