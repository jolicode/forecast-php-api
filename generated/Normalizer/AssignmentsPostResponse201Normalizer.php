...
if (!class_exists(Kernel::class) || (Kernel::MAJOR_VERSION >= 7 || Kernel::MAJOR_VERSION === 6 && Kernel::MINOR_VERSION === 4)) {
    class AssignmentsPostResponse201Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return \is_object($data) && 'JoliCode\\Forecast\\Api\\Model\\AssignmentsPostResponse201' === $data::class;
        }
        ...
        {
            return ['JoliCode\\Forecast\\Api\\Model\\AssignmentsPostResponse201' => false];
        }
    }
} else {
    class AssignmentsPostResponse201Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
